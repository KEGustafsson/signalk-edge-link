...
const { getAllPaths, PATH_CATEGORIES } = require("../pathDictionary.ts");
const {
  validateConnectionConfig,
  sanitizeConnectionConfig,
  validateUniqueServerPorts
} = require("../connection-config.ts");
const { validateRuntimeConfigBody } = require("./config-validation.ts");
...
function register(router, ctx) {
  ...
  function getConnectionIdentityKey(connection) {
