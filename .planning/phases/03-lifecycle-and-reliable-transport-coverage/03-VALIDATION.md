...
| ------- | ---- | ---- | ------------------------ | -------------- | ---------------------------------------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------- |
| 3-01-01 | 01   | 1    | V1-TEST-001              | T-3-01, T-3-02 | Stopped instances do not leak watchers, timers, or callbacks           | Jest fake timers     | `npm test -- --runTestsByPath __tests__/config-watcher.test.js __tests__/instance.test.js`                                                          | yes         | pending |
| 3-01-02 | 01   | 1    | V1-TEST-001              | T-3-03         | Client socket recovery can be cancelled safely by stop                 | Jest fake socket     | `npm test -- --runTestsByPath __tests__/instance.test.js`                                                                                           | yes         | pending |
| 3-02-01 | 02   | 2    | V1-TEST-002              | T-3-04, T-3-05 | ACK/NAK and retransmit behavior remains bounded and authenticated      | Jest protocol tests  | `npm test -- --runTestsByPath __tests__/v2/pipeline-v2-client-coverage.test.js __tests__/v2/pipeline-v2-server-coverage.test.js`                    | yes         | pending |
| 3-02-02 | 02   | 2    | V1-TEST-002              | T-3-06         | Sequence gaps and stale ACKs do not corrupt reliable state             | Jest primitive tests | `npm test -- --runTestsByPath __tests__/v2/sequence.test.js __tests__/v2/retransmit-queue.test.js`                                                  | yes         | pending |
| 3-03-01 | 03   | 3    | V1-TEST-002              | T-3-07, T-3-08 | Metadata/source restart and stale-envelope behavior is covered         | Jest v2 tests        | `npm test -- --runTestsByPath __tests__/v2/pipeline-v2-server.test.js __tests__/v2/meta-end-to-end.test.js __tests__/v2/source-replication.test.js` | yes         | pending |
| 3-03-02 | 03   | 3    | V1-TEST-001, V1-TEST-002 | T-3-09         | Socket recovery re-primes metadata/source state without leaking timers | Jest fake timers     | `npm test -- --runTestsByPath __tests__/instance.test.js __tests__/v2/pipeline-v2-client-coverage.test.js`                                          | yes         | pending |
