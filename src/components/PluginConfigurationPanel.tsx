...
const clientProperties = {
  ...
  helloMessageSender: {
    ...
    description:
      "Optional tuning. Send periodic heartbeat messages to keep NAT/firewall mappings alive.",
    default: 60,
    minimum: 10,
    maximum: 3600
  },
  ...
  reliability: {
    ...
    description:
      "Advanced. Requires Protocol v2 or v3. Controls retransmit queue behavior and retry limits.",
    properties: {
      retransmitQueueSize: {
        type: "number",
  ...
  congestionControl: {
    ...
    description:
      "Advanced. Requires Protocol v2 or v3. AIMD logic can adapt send rate based on RTT and packet loss.",
    properties: {
      enabled: {
        type: "boolean",
  ...
  bonding: {
    ...
    description:
      "Advanced. Requires Protocol v2 or v3. Configure dual-link operation with automatic failover.",
    properties: {
      enabled: {
        type: "boolean",
    ...
    (idx) => {
      setConnections((prev) => {
        ...
        setExpandedIndex((prevExpanded) =>
          prevExpanded >= idx && prevExpanded > 0 ? prevExpanded - 1 : prevExpanded
        );
        return next;
      });
      markDirty();
