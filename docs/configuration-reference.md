...
| Encryption Key | `secretKey` | string | - | 32 raw chars, 64 hex, or 43/44 base64 chars | Must match on both ends; prefer 64-char hex or base64 for full 256-bit entropy |
