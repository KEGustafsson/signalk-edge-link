...
- `api-reference.md` - REST endpoints, response examples, and monitoring/control routes (current: 2.7.0)
...
2. `api-reference.md` (metrics and monitoring endpoints, current: 2.7.0)
