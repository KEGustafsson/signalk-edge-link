...
const { validateRuntimeConfigBody } = require("../lib/routes/config-validation.ts");
const configRoutes = require("../lib/routes/config.ts");
const connectionsRoutes = require("../lib/routes/connections.ts");
